...
const MyOrdersPage = () => {
  ...
  return (
    <div className="max-w-7xl min-h-screen mx-auto p-4 sm:p-6">
                ...
                {orders.length > 0 ? (
                    orders.map((order) => (
                        ...
                        className="border-b hover:border-gray-50 cursor-pointer">
                            <td className="py-2 px-2 sm:px-2">
                                <img src={order.orderItems[0].image} alt={order.orderItems[0].name}
                                className="w-10 h-10 sm:h-15 sm:w-15 object-cover rounded-lg" />
                            </td>
                            <td className="py-2 px-2 sm:py-4 text-xs font-bold text-gray-900 whitespace-nowrap">#{order._id}</td>
                            <td className="py-2 px-2 sm:py-4 sm:px-4 text-xs">
