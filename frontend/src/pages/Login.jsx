  ...
  return (
    <div className="flex">
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-md bg-gray-100 backdrop-blur-2xl p-6 rounded-3xl shadow-2xl">
        ...
        <button type='submit' className="w-full bg-black text-white p-2 rounded-2xl font-semibold cursor-pointer hover:bg-gray-800 transition">{loading ? "Loading..." : "Sign In"}</button>
