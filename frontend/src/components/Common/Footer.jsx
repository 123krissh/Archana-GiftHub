...
const Footer = () => {
  return <footer className="border-1 border-gray-300 py-12">
    <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-5 lg:px-0">
        <div className="ml-10">
            ...
            <p className="text-gray-500 mb-3">Be the first to hear about new products, exclusive events, and online offers.</p>
            <p className="font-medium text-sm text-gray-600 mb-6">Sign up and get 10% off your first order.</p>

            {/* Newsletter form */}
            <form className="flex">
                <input type="email" placeholder="Enter your email" className="p-3 w-full md:w-40 text-sm border-t border-l border-b border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all" required />
    ...
    <div>
        ...
        <div className="flex items-center space-x-4 mb-6">
            ...
            <a href="https://www.whatsapp.com" target="_blank" rel="noopener noreferrer" className="hover:text-gray-500">
            <FaWhatsapp className="h-6 w-6" />
            </a>
        </div>
        <p className="text-gray-800">Call Us</p>
        <p> <FaPhoneAlt className="inline-block mr-2"/> +91 8619604816 </p>
    </div>
    </div> 
    {/* Footer Bottom */}
    <div className="container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6">
        <p className="text-gray-500 text-sm tracking-tighter text-center">&copy; 2025 GIFT HUB. All rights reserved. </p>
    </div>
  </footer>
}
