            ...
            <div className="relative flex-1 ">
                ...
                <div className="absolute bottom-8 left-8 bg-white bg-opacity-90 p-3 rounded-2xl shadow-2xl">
                    <h2 className="text-2xl font-bold text-gray-900 mb-1">Custom Collage</h2>
                     <Link to="/collections/all?product=Custom-Collage" className="text-gray-900 underline">Shop Now</Link>
                </div>
            </div>
            {/* Photo Frames */}
            <div className="relative flex-1">
                ...
                <div className="absolute bottom-8 left-8 bg-white bg-opacity-90 p-3 rounded-2xl shadow-2xl ">
                    <h2 className="text-2xl font-bold text-gray-900 mb-1">Photo Frames</h2>
                     <Link to="/collections/all?product=Photo-Frame" className="text-gray-900 underline">Shop Now</Link>
                </div>
            </div>
            {/* Custom Pillow */}
            <div className="relative flex-1">
                ...
                <div className="absolute bottom-8 left-8 bg-white bg-opacity-90 p-3 rounded-2xl shadow-2xl">
                    <h2 className="text-2xl font-bold text-gray-900 mb-1">Custom Pillow</h2>
                     <Link to="/collections/all?product=Custom-Pillow" className="text-gray-900 underline">Shop Now</Link>
                </div>
            </div>
            {/* Custom Cup */}
            <div className="relative flex-1">
                ...
                <div className="absolute bottom-8 left-8 bg-white bg-opacity-90 p-3 rounded-2xl shadow-2xl">
                    <h2 className="text-2xl font-bold text-gray-900 mb-1">Custom Cup</h2>
                     <Link to="/collections/all?product=Custom-Cup" className="text-gray-900 underline">Shop Now</Link>
                </div>
            </div>
        </div>
    </section>
