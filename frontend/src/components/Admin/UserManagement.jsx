...
const UserManagement = () => {
    ...
    const handleRolChanger = (userId, newRole) => {
        ...
        <tbody>
            {users.map((user) => (
                <tr key={user._id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="p-4">
                        <select value={user.role} onChange={(e) => handleRolChanger(user._id, e.target.value)} className="p-2 border rounded">
                            <option value="customer">Customer</option>
                            <option value="admin">Admin</option>
                        </select>
                    </td>
